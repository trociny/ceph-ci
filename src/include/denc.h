...
private:
  ...
  static void bound_encode_helper_nfnb(const T& s, size_t& p,
				       _denc::indices<I, Is...>) {
    denc(std::get<I>(s), p);
    bound_encode_helper_nfnb(s, p, _denc::indices<Is...>{});
  }
  ...
  static void bound_encode_helper_nfb(const T& s, size_t& p,
    ...
    bound_encode_helper_nfb(s, p, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void bound_encode_helper_nfb(const T& s, size_t& p,
				      _denc::indices<I>) {
  ...
  static void bound_encode_helper_fnb(const T& s, size_t& p, uint64_t f,
    ...
    bound_encode_helper_fnb(s, p, f, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void bound_encode_helper_fnb(const T& s, size_t& p, uint64_t f,
				      _denc::indices<I>) {
  ...
  static void bound_encode_helper_fb(const T& s, size_t& p, uint64_t f,
				     _denc::indices<I, Is...>) {
    denc(*(typename std::tuple_element<I, T>::type *)nullptr, p);
    bound_encode_helper_fb(s, p, f, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void bound_encode_helper_fb(const T& s, size_t& p, uint64_t f,
				     _denc::indices<I>) {
  ...
  static void encode_helper_nf(const T& s, buffer::list::contiguous_appender& p,
			       _denc::indices<I, Is...>) {
    denc(std::get<I>(s), p);
    encode_helper_nf(s, p, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void encode_helper_nf(const T& s, buffer::list::contiguous_appender& p,
			_denc::indices<I>) {
  ...
  static void encode_helper_f(const T& s, buffer::list::contiguous_appender& p,
			      uint64_t f, _denc::indices<I, Is...>) {
    denc(std::get<I>(s), p, f);
    encode_helper_nf(s, p, f, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void encode_helper_f(const T& s, buffer::list::contiguous_appender& p,
  ...
  static void decode_helper(T& s, buffer::ptr::iterator& p,
			    _denc::indices<I, Is...>) {
    denc(std::get<I>(s), p);
    decode_helper(s, p, _denc::indices<Is...>{});
  }
  template<typename T, size_t I>
  static void decode_helper(T& s, buffer::ptr::iterator& p,
		     _denc::indices<I>) {
